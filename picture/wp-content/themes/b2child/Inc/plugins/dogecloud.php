...
if (!empty(lmy_get_option('g_cos_fieldset')['g_cos'])) {
    function dogcloud_upload($object, $file, $mime)
    {
        ...
        if (@file_exists($file)) {
            $accessKey = lmy_get_option('g_cos_fieldset')['g_cos_accesskey'];
            $secretKey = lmy_get_option('g_cos_fieldset')['g_cos_secretkey'];
            $bucket = lmy_get_option('g_cos_fieldset')['g_cos_bucketname'];
    ...
    {
        $upload_path = '';
        $upload_url_path = lmy_get_option('g_cos_fieldset')['g_cos_url'];
