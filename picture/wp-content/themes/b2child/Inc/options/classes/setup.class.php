...
if ( ! class_exists( 'CSF_Setup' ) ) {
  class CSF_Setup {
    ...
    public static function add_admin_enqueue_scripts() {
      ...
      // Main scripts
      wp_enqueue_script( 'csf-plugins', self::include_plugin_url( 'assets/plugins'. $min .'.js' ), array(), self::$version, true );
      wp_enqueue_script( 'csf', self::include_plugin_url( 'assets/main'. $min .'.js' ), array( 'csf-plugins' ), self::$version, true );
