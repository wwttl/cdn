      ...
      if (preg_match('/' . preg_quote('[' . $this->field['id'] . ']') . '/', $this->unique)) {
        ...
        if (!empty($this->value)) {
          ...
          foreach ($this->value as $value) {
            ...
            echo '<i class="csf-cloneable-sort fas fa-arrows-alt"></i>';
            echo '<i class="csf-cloneable-clone far fa-clone"></i>';
            echo '<i class="csf-cloneable-remove csf-confirm fas fa-times" data-confirm="确实要删除此项目吗？"></i>';
            echo '</div>';
        ...
        echo '<div class="csf-cloneable-alert csf-cloneable-max">您无法添加更多内容。</div>';
        echo '<div class="csf-cloneable-alert csf-cloneable-min">无法删除更多。</div>';
        echo '<a href="#" class="button button-primary csf-cloneable-add">添加</a>';
